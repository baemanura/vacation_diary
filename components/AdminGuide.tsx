        ...
        <div className="px-6 pb-6 pt-2 border-t border-gray-200 space-y-6 text-sm text-gray-700">
          ...
          <Section title="새 대원이 전입했을 때">
            <ol className="space-y-1 list-decimal list-inside">
              ...
              <li>
                화면에 <B>임시 비밀번호</B>가 뜹니다. 이 값을 본인에게 전달하세요.
              </li>
              <li>
                그 대원이 <B>이름 + 계급</B>(예: <Code>홍길동 경사</Code>)과 임시 비밀번호로
                로그인하면, 본인 비밀번호로 바꾸는 화면이 먼저 나옵니다.
              </li>
            </ol>
            <Callout tone="warn">
              임시 비밀번호는 <B>그 화면에서 한 번만</B> 보이고 서버에 저장되지 않습니다. 놓쳤다면
              대원 목록의 🔑 버튼으로 새로 발급하면 됩니다.
            </Callout>
          </Section>
