          ...
          <Section title="대원 목록의 버튼 세 개">
            <ul className="space-y-2">
              ...
              <li>
                ...
                전출자만 지우세요. 그 사람은 더 이상 로그인할 수 없게 되고, 남긴 지난 연가 기록은{' '}
                <B>&apos;알 수 없음&apos;</B>으로 표시됩니다.
              </li>
            </ul>
            <Callout tone="warn">
              <B>Supabase 대시보드에서 로그인 계정을 직접 지우지 마세요.</B> 이 페이지에서 대원을
              삭제하면 로그인은 이미 막힙니다. 거기서 계정까지 지우면 그 사람의{' '}
              <B>연가 기록과 게시글이 함께 사라집니다.</B>
            </Callout>
            <Callout tone="warn">
